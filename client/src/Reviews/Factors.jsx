...
var Factors = ({metaReviews}) => {
  ...
  return [['Size', 'Small', 'Perfect', 'Big'], ['Width', 'Narrow', 'Perfect', 'Wide'], ['Comfort', 'Not Comfortable', '', 'Perfect'], ['Quality', 'Low Quality', '', 'Perfect'], ['Length', 'Too Short', 'Perfect', 'Too Long'], ['Fit', 'Too Small', 'Perfect', 'Too Big']].map((factor) => {
